    ...
    class Particle {
      ...
      position() {
        ...
        if (distance < properties.mouseRadius) {
          ...
          this.velocityX = this.baseVelocityX + (Math.cos(angle) * force * 2)
          this.velocityY = this.baseVelocityY + (Math.sin(angle) * force * 2)
        } else {
          // Gradually return to base velocity
          this.velocityX = this.velocityX * 0.98 + this.baseVelocityX * 0.02
          this.velocityY = this.velocityY * 0.98 + this.baseVelocityY * 0.02
        }
